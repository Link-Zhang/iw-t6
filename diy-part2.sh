...
# Modify hostname
sed -i 's|ImmortalWrt|NanoPC-T6|g' package/base-files/files/bin/config_generate

# Change ash to bash
sed -i 's|/bin/ash|/bin/bash|g' package/base-files/files/etc/passwd

# Change default root password
sed -i 's|root:::0:99999:7:::|root:$1$CVCXbKh9$r5w6F.rsYfy3Uszzi7TuD0:19847:0:99999:7:::|g' package/base-files/files/etc/shadow
